...
export const sousStake = async (sousChefContract, amount, account) => {
  return sousChefContract.methods
    .deposit(new BigNumber(amount).times(new BigNumber(10).pow(6)).toString())
    .send({ from: account })
...
export const sousStakeBnb = async (sousChefContract, amount, account) => {
  return sousChefContract.methods
    .deposit()
    .send({ from: account, value: new BigNumber(amount).times(new BigNumber(10).pow(6)).toString() })
    .on('transactionHash', (tx) => {
      return tx.transactionHash
    })
}
...
export const sousUnstake = async (sousChefContract, amount, account) => {
  ...
  return sousChefContract.methods
    .withdraw(new BigNumber(amount).times(new BigNumber(10).pow(6)).toString())
    .send({ from: account })
    .on('transactionHash', (tx) => {
      return tx.transactionHash
    })
